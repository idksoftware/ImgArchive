...
namespace simplearchive {
	...
	bool WebArgvParser::doInitalise(int argc, char **argv) {
...
//			printf(opt.c_str()); printf("\n");
	...
	std::string WebArgvParser::usageDescriptionHeader(unsigned int _width) const
	{
		std::string usage;
	...
	std::string WebArgvParser::commandUsage(unsigned int width) const
	{
	...
	std::string WebArgvParser::generalHelp(unsigned int _width) const
	{
		std::string usage; // the usage description text

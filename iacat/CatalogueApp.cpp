...
namespace simplearchive {
	...
	CatalogueApp::CatalogueApp() : AppBase(std::make_shared<CatalogueArgvParser>()) {};

bool CatalogueApp::Show() {
...
bool CatalogueApp::doInitalise(int argc, char **argv) {
	/*
	...
	*/
	CatalogueArgvParser catalogueArgvParser;
	if (catalogueArgvParser.initalise(argc, argv) == false) {
...
bool CatalogueApp::initaliseConfig() {
...
// AppConfig &config = AppConfig::get();
bool CatalogueApp::initaliseHomePath() {
...
bool CatalogueApp::initaliseArgs(int argc, char **argv) {
...
{
	simplearchive::CatalogueApp app;

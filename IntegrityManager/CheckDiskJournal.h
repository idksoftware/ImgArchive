...
namespace simplearchive
{
	...
	*/
	class CheckDiskJournal
	{
		...
		std::string writeTag(const char* tag, int value, int tab);
	...
	public:
		...
		void update(ReportStatus reportStatus)
		{
			...
			{
			case ReportStatus::Status::Unknown: m_unknown++;
				break;
			case ReportStatus::Status::ContentChanged: m_contentChanged++;
				break;
			case ReportStatus::Status::NameChanged: m_nameChanged++;
				break;
			case ReportStatus::Status::Missing: m_missing++;
				break;
			case ReportStatus::Status::Added: m_added++;
				break;
			case ReportStatus::Status::CheckedOutNoChange: m_checkedOutNoChange++;
				break;
			case ReportStatus::Status::CheckedOutChanged: m_checkedOutChanged++;
				break;
			case ReportStatus::Status::Unchanged: m_unchanged++;
				break;
			}
		}
